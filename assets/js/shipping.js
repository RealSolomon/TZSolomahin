...
window.onclick = function(e) {
  ...
  if (e.target.tagName === 'LI' && activeDropdown){
    if (e.target.innerHTML === 'EXPRESS SHIPPING') {
      document.getElementById('person-card-image').src = './assets/images/Express.png';
      ...
      document.getElementById('current-card').innerHTML = 'EXPRESS SHIPPING';
         ...
         document.getElementById('person-card-image').src = './assets/images/Courier.png';
          activeDropdown.classList.remove('visible');
      activeDropdown = null;
      e.target.innerHTML = document.getElementById('current-card').innerHTML;
      document.getElementById('current-card').innerHTML = 'COURIER SHIPPING';      
         ...
         document.getElementById('person-card-image').src = './assets/images/Free.png';
          activeDropdown.classList.remove('visible');
      activeDropdown = null;
      e.target.innerHTML = document.getElementById('current-card').innerHTML;
